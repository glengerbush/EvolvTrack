-- Follow-up fence for key-bundle writes. The transition finalizer locks the
-- key table with the sync tables; afterward RLS accepts only the authoritative
-- active/pending version for the account mode.
